...
import 'data/datasources/service_type_local_ds.dart';
  ...
  runApp(
    MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(create: (c) => CustomerVM(c.read())..load()),
        ChangeNotifierProvider(create: (c) => PerfumeVM(c.read())..load()),
